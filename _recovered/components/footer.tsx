        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
               ...
               <div>
                  <h3 className="text-2xl font-bold text-white tracking-tight">Enzo Elite Sports</h3>
            ...
            <div className="space-y-4 pt-2">
               ...
               <a href="mailto:EnzoEliteSports@gmail.com" className="flex items-center gap-3 group">
                   <div className="w-9 h-9 rounded-lg bg-indigo-900/50 flex items-center justify-center text-indigo-300 group-hover:bg-indigo-600 group-hover:text-white transition-all duration-300">
                     <Mail size={16} />
                  </div>
                  <span className="text-indigo-200 text-sm font-medium break-all group-hover:text-white transition-colors">EnzoEliteSports@gmail.com</span>
               </a>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
              <div className="space-y-1">
                <p className="text-indigo-300 text-sm">
                   � {new Date().getFullYear()} <span className="text-white font-semibold">Enzo Elite Sports</span>. All rights reserved.
                </p>
                {/* CREDIT ADDED HERE */}
