          ...
          <div className="grid lg:grid-cols-2 gap-16 xl:gap-24 items-center">
            ...
            <div>
              ...
              <p className="mt-8 text-slate-600 text-lg leading-8 max-w-xl">
                Unleash creativity through painting, sculpting, and design. Where imagination meets technique.
              </p>
            ...
            <div className="relative w-full h-full min-h-[500px]">
               <div className="absolute top-0 right-0 w-[80%] h-[60%] rounded-[3rem] overflow-hidden shadow-2xl z-10 border-4 border-white">
                 <img src="https://images.unsplash.com/photo-1513364776144-60967b0f800f?q=80&w=1200" alt="Art & Craft Training" className="w-full h-full object-cover hover:scale-105 transition duration-700" />
      ...
      <section className="py-24 container mx-auto px-6 max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
           ...
           <div className="order-2 lg:order-1 relative rounded-[3rem] overflow-hidden shadow-2xl h-[500px]">
             <img src="https://images.unsplash.com/photo-1513364776144-60967b0f800f?q=80&w=1200" alt="FAQ Background" className="w-full h-full object-cover" />
